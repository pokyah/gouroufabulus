...
#     model="tgi",
#     api_key=HF_TOKEN,
#     api_base="https://ndncm9zlhalp3ic3.us-east-1.aws.endpoints.huggingface.cloud" + "/v1/",
#     is_chat_model=True,
#     is_local=False,
...
if st.session_state.messages[-1]["role"] == "user":
    with st.chat_message("assistant", avatar=gouroufabulus_filepath):
        ...
        if response:
            ...
            text_to_add = "\n\nTu pourras peut-être trouver plus d’infos dans ce document (peut-être, j’ai pas vérifié):"
